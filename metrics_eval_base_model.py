...
def main(mdl,dataset):
    ...
    tokenizer = AutoTokenizer.from_pretrained(args['tokenizer_name'],cache_dir=cache_path)
    ...
    json.dump(data_dict, open(args["Save_path"] + mdl+"_on_"+dataset+"_base_"+".json",'w'))

if __name__ == "__main__":
    mdl     = ["DialoGPT", "DialoGPT", "DialoGPT"]
    dataset = ["CONAN", "Reddit", "Gab"]
